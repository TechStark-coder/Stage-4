      ...
      <Card className="shadow-lg border-dashed border-muted-foreground/30 bg-card/80 h-full flex flex-col">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-muted-foreground">
            <ImageIcon className="h-6 w-6" /> Image Gallery
          </CardTitle>
        </CardHeader>
  ...
  return (
    <Card className="shadow-lg h-full flex flex-col">
      <CardHeader>
        ...
        <CardDescription>
          Review current photos and add new ones for analysis.
        </CardDescription>
      </CardHeader>
      <CardContent className="flex-grow space-y-6">
        {hasAnalyzedPhotos && (
          <div>
            <h3 className="text-sm font-medium text-muted-foreground mb-3">
              Analyzed Photos ({analyzedPhotoUrls.length})
            </h3>
        ...
        {hasPendingPhotos && (
          <div>
            <h3 className="text-sm font-medium text-muted-foreground mb-3">
              New Photos for Analysis ({pendingPhotos.length})
            </h3>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-4">
